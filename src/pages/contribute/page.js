const Contribute = () => {
  return (
    ...
    <div className="p-10 bg-gray-200 shadow-inner shadow-lg">
        <span className="text-blue-400 text-4xl font-bold pl-8" style={{fontFamily: "Fredoka"}}>Get Started - open source contribution</span>
      </div>
      <div className="container-fluid mx-auto my-8">
        <div className="md:w-3/4 mx-8 lg:mx-auto">
          <h2 className="text-3xl font-extrabold mt-4 mb-3">What is open source?</h2>
          <p className="text-lg">
          ...
          <h2 className="text-3xl font-extrabold mt-6 mb-3">What makes open source possible?</h2>
          <p className="text-lg">
            ...
            popular tools used by researchers, companies, and students; at ACM, we use both.
          </p>

          <h2 className="text-3xl font-extrabold mt-6 mb-3">How can I contribute?</h2>
          <p className="text-lg">
          ...
          <h2 className="text-3xl font-extrabold mt-6 mb-3">Jumping into contributing on a project</h2>
          <p className="text-lg">
          ...
          <h2 className="text-3xl font-extrabold mt-6 mb-3">Contribution workflow</h2>
          <p className="text-lg">
            Repositories normally tell you how the steps you need to take to
            get to work, usually within their README.md or their
          ...
          <h2 className="text-3xl font-extrabold mt-6 mb-3">Forking and cloning a repo</h2>
          <p className="text-lg">
            ...
            <br />
            <code className="text-pink-600">$ git clone git@github.com:Kamran1819G/opensource.git</code>
            <br />
          ...
          <p className="text-lg">
            ...
            <code className="text-pink-600">git checkout -b BRANCH_NAME</code> command to generate a new
            branch or <code className="text-pink-600">git checkout BRANCH_NAME</code> to switch between
            branches.
            <br />
            After you&apos;ve made your changes, run <code className="text-pink-600">git add .</code> then{" "}
            <code className="text-pink-600">git commit -m &quot;a short commit description&quot;</code> to take a
            snapshot of all the changes you&apos;ve made and git push to push the
            changes you made to GitHub.
          </p>

          <h2 className="text-3xl font-extrabold mt-6 mb-3">Making a pull request</h2>
          <p className="text-lg">
